...
% Compile: pdflatex progress_report.tex && bibtex progress_report && pdflatex progress_report.tex
...
\graphicspath{{../thesis/images/}} % Point to images in thesis folder
...
\begin{itemize}
    ...
    \item \textbf{Simulation Results:} In digital twin tests, the RL agent reduces harvest timing error to 1.50~days (vs. 2.46~days for fixed schedules) and eliminates thermal safety violations.
\end{itemize}
...
\nocite{*} % Force all bib entries to appear
