...
\section{DQN Training Convergence}
    ...
    \begin{figure}[ht]
        \centering
        \includegraphics[width=0.8\textwidth]{policy_improvement.png}
...
\section{Distillation Training Convergence}
    ...
    \begin{figure}[ht]
        ...
        \caption{Student model distillation convergence showing cross-entropy loss (left) and action prediction accuracy (right) over 100 training epochs. Final accuracy reaches 97.8\%, exceeding the 95\% fidelity target (red dashed line).}
