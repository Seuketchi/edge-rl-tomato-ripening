...
\title{Edge-RL: Reinforcement Learning-Enhanced Edge Intelligence for Post-Harvest Tomato Ripening Optimization}
...
\begin{enumerate}
    ...
    \item[\textbf{O3.}] \textit{Practical affordability}: A complete vision + RL edge intelligence system can be built for under \$50, providing autonomous agricultural decision support at a price point accessible to smallholder farmers.
\end{enumerate}
...
\begin{tikzpicture}[font=\scriptsize]
    ...
    \node[right, font=\tiny] at (1.9, 1.57) {\textbf{RL Policy (35K)}};
